...
from server.tasks.v1.macroscop.contacts import contacts_parse
from server.tasks.v1.macroscop import urls
...
def task() -> None:
    try:
        logger.info('Running Macroscop tasks')
        asyncio.run(main())
        logger.info('Macroscop tasks is finished')
