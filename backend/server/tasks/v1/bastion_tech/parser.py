...
from server.tasks.v1.bastion_tech.contacts import contacts_parse
from server.tasks.v1.bastion_tech import urls
...
def task() -> None:
    try:
        logger.info('Running Bastion tasks')
        asyncio.run(main())
        logger.info('Bastion tasks is finished')
