...
from server.tasks.v1.parsec.contacts import contacts_parse
from server.tasks.v1.parsec import urls
...
def task() -> None:
    try:
        logger.info('Running Parsec tasks')
        asyncio.run(main())
        logger.info('Parsec tasks is finished')
