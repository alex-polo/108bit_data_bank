...
from server.tasks.v1.ironlogic.contacts import contacts_parse
from server.tasks.v1.ironlogic import urls
...
def task() -> None:
    try:
        logger.info('Running Ironlogic tasks')
        asyncio.run(main())
        logger.info('Ironlogic tasks is finished')
